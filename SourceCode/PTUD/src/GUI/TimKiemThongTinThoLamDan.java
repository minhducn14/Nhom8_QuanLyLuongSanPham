...
public class TimKiemThongTinThoLamDan extends JPanel {
	...
	public TimKiemThongTinThoLamDan() {
	    ...
	    add(lblNewLabel);
	    lblNewLabel.setText("TÌM KIẾM THÔNG TIN THỢ LÀM ĐÀN");
	    ...
	    btnTmKim.setBounds(499, 237, 170, 50);
	    panel.add(btnTmKim);
	    ...
	    btnXoRng.setBounds(803, 237, 170, 50);
	    panel.add(btnXoRng);
	    
	    JPanel panel_1 = new JPanel();
	    panel_1.setBackground(new Color(255, 255, 255));
	    panel_1.setBounds(91, 65, 560, 25);
	    panel.add(panel_1);
	    ...
	    panel_1_4.setBounds(446, 179, 560, 25);
	    panel.add(panel_1_4);
