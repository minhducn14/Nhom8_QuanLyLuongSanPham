...
public class LuongThoLamDan extends JPanel {
	...
	public LuongThoLamDan() {
		...
		JLabel lblSNgayLamChuNhat = new JLabel("Khóa đàn");
		...
		tbl_BangLuong.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00E3 Th\u1EE3 L\u00E0m \u0110\u00E0n", "H\u1ECD T\u00EAn", "Ph\u1EE5 c\u1EA5p th\u00E2m ni\u00EAn", "Ti\u1EC1n L\u01B0\u01A1ng", "T\u1ED5ng Ti\u1EC1n L\u01B0\u01A1ng"
			}
		) {
		...
		JLabel lblThongTin_1 = new JLabel("Thợ làm đàn");
		...
		tbl_NhanVien.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00E3 TLD", "H\u1ECD t\u00EAn", "Gi\u1EDBi t\u00EDnh", "Ng\u00E0y sinh", "CMND", "S\u1ED1 \u0110i\u1EC7n Tho\u1EA1i"
			}
		) {
			boolean[] columnEditables = new boolean[] {
		...
		btnTnhTonB_1.setIcon(new ImageIcon(LuongThoLamDan.class.getResource("/icons/search_icon.png")));
