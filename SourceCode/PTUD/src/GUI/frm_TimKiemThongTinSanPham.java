...
public class frm_TimKiemThongTinSanPham extends JPanel implements ActionListener {
	...
	public frm_TimKiemThongTinSanPham() {
		...
		JLabel lblKQ = new JLabel("New label");
		lblKQ.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblKQ.setBounds(50, 450, 217, 25);
		add(lblKQ);
		lblKQ.setText("Kết quả tìm kiếm\r\n");
		...
		JLabel lblTimKiemTheo = new JLabel("Tìm kiếm sản phẩm theo :");
		lblTimKiemTheo.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblTimKiemTheo.setBounds(35, 15, 304, 25);
		panel.add(lblTimKiemTheo);
