...
public class DAO_ThongKe {
	...
	//==============================
		public static DefaultTableModel allMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel allMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongKinhDoanhMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
			...
			Connection connection = MyConnection.getInstance().getConnection();
			try {
				String sql = "select top 5 nv.maNhanVien, cnv.hoTen, cnv.gioiTinh, pb.tenPhongBan,cnv.maCanCuocCongDan, cnv.soDienThoai, (nv.luongCoBan+(blnv.soNgayLamChuNhat + blnv.soNgayThuongDiLam)*30000+blnv.soGioTangCaChuNhat*1.5*25000+blnv.soGioTangCaNgayThuong*25000) as tongLuong\r\nfrom NhanVien nv join CongNhanVien cnv \r\n		on cnv.maCongNhanVien=nv.maCongNhanVien\r\n		join BangLuongNhanVien blnv\r\n		on blnv.maNhanVien=nv.maNhanVien\r\n		join PhongBan pb\r\n		on pb.maPhongBan=nv.maPhongBan\r\nwhere thang=" + thang +" and nam=" + nam +" and pb.tenPhongBan='Kinh Doanh'\r\n order by tongLuong desc";
				try (PreparedStatement statement = connection.prepareStatement(sql)) {
					try (ResultSet resultSet = statement.executeQuery()) {
						while (resultSet.next()) {
							String manv = resultSet.getString("maNhanVien");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongKinhDoanhMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongMarketingMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
			...
			Connection connection = MyConnection.getInstance().getConnection();
			try {
				String sql = "select top 5 nv.maNhanVien, cnv.hoTen, cnv.gioiTinh, pb.tenPhongBan,cnv.maCanCuocCongDan, cnv.soDienThoai, (nv.luongCoBan+(blnv.soNgayLamChuNhat + blnv.soNgayThuongDiLam)*30000+blnv.soGioTangCaChuNhat*1.5*25000+blnv.soGioTangCaNgayThuong*25000) as tongLuong\r\nfrom NhanVien nv join CongNhanVien cnv \r\n		on cnv.maCongNhanVien=nv.maCongNhanVien\r\n		join BangLuongNhanVien blnv\r\n		on blnv.maNhanVien=nv.maNhanVien\r\n		join PhongBan pb\r\n		on pb.maPhongBan=nv.maPhongBan\r\nwhere thang=" + thang +" and nam=" + nam +" and pb.tenPhongBan='Marketing'\r\n order by tongLuong desc";
				try (PreparedStatement statement = connection.prepareStatement(sql)) {
					try (ResultSet resultSet = statement.executeQuery()) {
						while (resultSet.next()) {
							String manv = resultSet.getString("maNhanVien");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongMarketingMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongNhanSuMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
			...
			try {
				String sql = "select top 5 nv.maNhanVien, cnv.hoTen, cnv.gioiTinh, pb.tenPhongBan,cnv.maCanCuocCongDan, cnv.soDienThoai, "
						...
						+ "from NhanVien nv join CongNhanVien cnv \r\n		on cnv.maCongNhanVien=nv.maCongNhanVien\r\n		"
						+ "join BangLuongNhanVien blnv\r\n		on blnv.maNhanVien=nv.maNhanVien\r\n		join PhongBan pb\r\n		"
						+ "on pb.maPhongBan=nv.maPhongBan\r\nwhere thang=" + thang +" and nam=" + nam +" and pb.tenPhongBan=N'Nhân Sự'\r\n "
								+ "order by tongLuong desc";
				try (PreparedStatement statement = connection.prepareStatement(sql)) {
					try (ResultSet resultSet = statement.executeQuery()) {
						while (resultSet.next()) {
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongNhanSuMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongPhatTrienSanPhamMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
			...
			try {
				String sql = "select top 5 nv.maNhanVien, cnv.hoTen, cnv.gioiTinh, pb.tenPhongBan,cnv.maCanCuocCongDan, cnv.soDienThoai, "
						...
						+ "from NhanVien nv join CongNhanVien cnv \r\n		on cnv.maCongNhanVien=nv.maCongNhanVien\r\n		"
						+ "join BangLuongNhanVien blnv\r\n		on blnv.maNhanVien=nv.maNhanVien\r\n		join PhongBan pb\r\n		"
						+ "on pb.maPhongBan=nv.maPhongBan\r\nwhere thang=" + thang +" and nam=" + nam +" and pb.tenPhongBan=N'Phát Triển Sản Phẩm'\r\n "
								+ "order by tongLuong desc";
				try (PreparedStatement statement = connection.prepareStatement(sql)) {
					try (ResultSet resultSet = statement.executeQuery()) {
						while (resultSet.next()) {
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongPhatTrienSanPhamMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongDieuPhoiMax(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
			...
			try {
				String sql = "select top 5 nv.maNhanVien, cnv.hoTen, cnv.gioiTinh, pb.tenPhongBan,cnv.maCanCuocCongDan, cnv.soDienThoai, "
						...
						+ "from NhanVien nv join CongNhanVien cnv \r\n		on cnv.maCongNhanVien=nv.maCongNhanVien\r\n		"
						+ "join BangLuongNhanVien blnv\r\n		on blnv.maNhanVien=nv.maNhanVien\r\n		join PhongBan pb\r\n		"
						+ "on pb.maPhongBan=nv.maPhongBan\r\nwhere thang=" + thang +" and nam=" + nam +" and pb.tenPhongBan=N'Điều Phối'\r\n "
								+ "order by tongLuong desc";
				try (PreparedStatement statement = connection.prepareStatement(sql)) {
					try (ResultSet resultSet = statement.executeQuery()) {
						while (resultSet.next()) {
...
//							String gioiTinh = resultSet.getString("gioiTinh");
		...
		public static DefaultTableModel phongDieuPhoiMin(int thang, int nam) {
			DefaultTableModel model = new DefaultTableModel();
			model.addColumn("Mã số");
			model.addColumn("Họ Tên");
			model.addColumn("Giới tính");
